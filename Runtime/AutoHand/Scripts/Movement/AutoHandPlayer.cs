...
namespace Autohand {
    ...
    public class AutoHandPlayer : MonoBehaviour {
        ...
        protected virtual void StartPush(Hand hand, GameObject other, Collision collision) { //NOTE: collision added by mbell 5/5/22
        ...
        protected virtual void StopPush(Hand hand, GameObject other, Collision collision) { //NOTE: collision added by mbell 5/5/22
            if(!allowBodyPushing)
                return;
